...
def transfer_bysig(tok: RUToken, src, dst, sender, sk, amount): # type: ignore
        print("transfer_bysig RUToken-----------------",tok)
        print("transfer_bysig src-----------------",src)
        print("transfer_bysig dst-----------------",dst)
        print("transfer_bysig sender-----------------",sender)
        print("transfer_bysig sk-----------------",sk)
        nonce,sig = generate_nonce_and_second_signature_transfer2of3(tok, sk, src, dst, amount)
        print("transfer_bysig-----------------",(nonce,sig))
...
def test_multiple_transfer2of3(accounts, localaccounts, deploy_multisigs):
    ...
    def transfer_bysig_local3(tok: RUToken, src, dst, sender, amount): # type: ignore
...
def test_bad_secondsig_transfer2of3(accounts, localaccounts, deploy_multisigs):
    ...
    def transfer_bysig_local4(tok: RUToken, src, dst, sender, amount): # type: ignore
